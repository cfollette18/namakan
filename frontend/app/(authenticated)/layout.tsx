...
export default function AuthenticatedLayout({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
      {/* Top Navigation */}
      <nav className="fixed top-0 left-0 right-0 z-50 bg-slate-950/80 backdrop-blur-xl border-b border-teal-500/20">
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <ThemeToggle />
              <button className="p-2 rounded-xl bg-slate-900/50 border border-slate-700 hover:border-teal-500/50 transition-all relative">
                <Bell className="w-5 h-5 text-slate-400" />
                <span className="absolute top-1 right-1 w-2 h-2 bg-teal-500 rounded-full"></span>
              </button>

              <div className="relative group">
                <button className="p-2 rounded-xl bg-slate-900/50 border border-slate-700 hover:border-teal-500/50 transition-all flex items-center gap-2">
                ...
                <div className="absolute right-0 mt-2 w-48 bg-slate-900 border border-slate-700 rounded-xl shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all">
                  ...
                  <button
                    className="flex items-center gap-3 px-4 py-3 hover:bg-slate-800 transition-colors w-full text-left last:rounded-b-xl text-slate-400 hover:text-teal-400"
                  >
      ...
      {/* Side Navigation */}
      <aside className="fixed left-0 top-20 bottom-0 w-64 bg-slate-900/50 backdrop-blur border-r border-teal-500/20 p-6 hidden lg:block">
        ...
        {/* Quick Actions */}
        <div className="mt-8 p-4 bg-gradient-to-br from-teal-500/10 to-teal-600/10 border border-teal-500/30 rounded-xl">
          <h3 className="text-sm font-semibold text-teal-400 mb-3">Quick Actions</h3>
      ...
      <nav className="fixed bottom-0 left-0 right-0 lg:hidden bg-slate-950/95 backdrop-blur border-t border-teal-500/20 z-50">
